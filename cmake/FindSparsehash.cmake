...
IF (SPARSEHASH_INCLUDE_DIRS)
    SET(SPARSEHASH_FOUND "YES")
ELSE (SPARSEHASH_INCLUDE_DIRS)
  SET(SPARSEHASH_FOUND "NO")
...
IF (SPARSEHASH_FOUND)
    MESSAGE(STATUS "Found Sparsehash: ${SPARSEHASH_INCLUDE_DIRS}")
ELSE (SPARSEHASH_FOUND)
   IF (SPARSEHASHFIND_REQUIRED)
      MESSAGE(FATAL_ERROR "Could not find Google sparsehash library")
   ENDIF (SPARSEHASHFIND_REQUIRED)
ENDIF (SPARSEHASH_FOUND)
