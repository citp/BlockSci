...
struct AddTaggedClusterMethods {
    ...
    void operator()(FuncApplication func) {
        ...
        func(property_tag, "tagged_addresses", +[](TaggedCluster &t) -> Iterator<TaggedAddress> { return t.taggedAddresses; }, "Return the list of addresses inside the cluster which have been tagged");
    }
};
