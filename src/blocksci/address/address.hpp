...
namespace blocksci {
    ...
    struct Address {
        ...
        uint64_t calculateBalance(BlockHeight height = 0, const AddressIndex &index, const ChainAccess &chain) const;
        ...
        uint64_t calculateBalance(BlockHeight height = 0) const;
