...
public:
    ...
    blocksci::IndexedFileMapper<boost::iostreams::mapped_file::readwrite, uint64_t> txVpubFile;
    ...
    void writeTransactionUintIndex();
    void writeTransactionUint(uint64_t vpub);
