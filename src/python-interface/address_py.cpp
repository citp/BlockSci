...
void init_address(py::module &m) {
    ...
    .def("balance_at_height", py::overload_cast<BlockHeight>(&Address::calculateBalanceAtHeight, py::const_), "Returns the balance held by this address when the chain was at the given height")
